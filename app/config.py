...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get('DATABASE_URL')  or f'postgresql://kacatcher:{password}@127.0.0.1:5432/minigofundme' # or 'sqlite:///'+ os.path.join(basedir, 'MiniGoFundMe.db')
